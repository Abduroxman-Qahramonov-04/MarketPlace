package com.example.market_place.Addresses;
...
public class Address {
    ...
    public Address(int id, User user, String addressLine1, String addressLine2, String city, String country, String postCode, boolean active) {
        this.id = id;
        this.user = user;
